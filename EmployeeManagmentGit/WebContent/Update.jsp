...
<body>
	...
	<sql:query var="listdesign" dataSource="${myDS }">select * from designationlist where Type='Designation';</sql:query>
	<sql:query var="team" dataSource="${myDS }">select * from designationlist where Type='Team';</sql:query>
	<sql:query var="qualific" dataSource="${myDS }">select * from designationlist where Type='Qualification';</sql:query>
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<html:form action="/update1" method="updateDisplay"
								onsubmit="return formValidatio()">
								<c:forEach var="user" items="${listEmp.rows}">
									<fmt:parseDate value="${user.Date_of_birth }" var="DOBirth"
										pattern="yyyy-MM-dd" />
									<fmt:formatDate value="${DOBirth}" pattern="yyyy-MM-dd"
										var="DOBirth1" />
									<fmt:parseDate value="${user.Date_of_joining}" var="DOJoining"
										pattern="yyyy-MM-dd" />
									<fmt:formatDate value="${DOJoining}" pattern="yyyy-MM-dd"
										var="DOJoining1" />
									<fmt:parseDate value="${user.Date_of_registration}"
										var="DORegistration" pattern="yyyy-MM-dd" />
									<fmt:formatDate value="${DORegistration}" pattern="yyyy-MM-dd"
										var="DORegistration1" />
									<fmt:parseDate value="${user.Increment_amount_date}"
										var="IncrementAmtDate" pattern="yyyy-MM-dd" />
									<fmt:formatDate value="${IncrementAmtDate}"
										pattern="yyyy-MM-dd" var="IncrementAmtDate1" />
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="emp_name" name="registrationForm"
													styleId="emp_name" styleClass="form-control"
													value="${user.Emp_name }"></html:text>
											</div>
										</div>
									</div>
									<br>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:select property="designation"
													...
													styleId="designation" name="registrationForm">


													<c:forEach var="design" items="${listdesign.rows}">
														<html:option value="${design.Name }">${design.Name }</html:option>
													</c:forEach>
												</html:select>
											</div>
										</div>
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-md-5">
												...
												<html:select property="team" value="${user.Team }"
													styleClass="form-control" styleId="team"
													name="registrationForm">
													<c:forEach var="design" items="${team.rows}">
														<html:option value="${design.Name }">${design.Name }
												</html:option>
													</c:forEach>
												</html:select>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="work_location" name="registrationForm"
													styleId="work_location" styleClass="form-control"
													value="${user.Work_location}"></html:text>
											</div>
										</div>
									</div>
									<br>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<div class="input-group date">
													...
													<div>
														<html:text property="date_of_birth"
															name="registrationForm" styleId="date_of_birth"
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:select property="gender" value="${user.Gender }"
													styleId="gender" styleClass="form-control"
													name="registrationForm">
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="fathers_name" name="registrationForm"
													styleId="fathers_name" styleClass="form-control"
													value="${user.Fathers_name }"></html:text>
											</div>
										</div>
									</div>
									<br>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="fathers_contact_details"
													...
													styleId="fathers_contact_details"
											...
											<div class="col-md-5">
												<div class="input-group">
													...
													<html:textarea property="local_address"
														styleId="local_address" name="registrationForm"
														styleClass="form-control" value="${user.Local_address }"></html:textarea>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="col-md-5">
												<div class="input-group">
													...
													<html:text property="contact_no" name="registrationForm"
														styleId="contact_no" styleClass="form-control"
														value="${user.Contact_no }" size="10" maxlength="10"></html:text>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="col-md-5">
												<div class="input-group">
													...
													<html:select property="highest_qualification"
														styleId="highest_qualification"
														value="${user.Highest_qualification }"
														styleClass="form-control" 
														name="registrationForm">
														<c:forEach var="design" items="${qualific.rows}">
															<html:option value="${design.Name }">${design.Name }
												</html:option>
														</c:forEach>
													</html:select>
												...
												<div class="input-group date">
													...
													<div>
														<html:text property="date_of_joining"
															styleId="date_of_joining" name="registrationForm"
															styleClass="form-control pull-right datepicker"
												...
												<div class="input-group date">
													...
													<div>
														<html:text property="date_of_registration"
															styleId="date_of_registration" name="registrationForm"
															styleClass="form-control pull-right datepicker"
											...
											<div class="col-md-5">
												<div>
													<html:text property="salary_at_the_time_of_joining"
														name="registrationForm" styleClass="form-control"
														styleId="salary_at_the_time_of_joining"
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="passport_no" name="registrationForm"
													styleId="passport_no" styleClass="form-control"
													value="${user.Passport_no }"></html:text>
											</div>
										</div>
									</div>
									<br>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="pancard_no" name="registrationForm"
													styleId="pancard_no" styleClass="form-control"
													value="${user.Pan_card_no }"></html:text>
											</div>
										</div>
									</div>
									<br>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="pF_no" name="registrationForm"
													styleId="pF_no" styleClass="form-control"
													value="${user.PF_no }"></html:text>
											</div>
										</div>
									</div>
									<br>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="official_bank_account_no"
													name="registrationForm" styleClass="form-control"
													styleId="official_bank_account_no"
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="employee_personal_bank_name"
													name="registrationForm" styleClass="form-control"
													styleId="employee_personal_bank_name"
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="personal_bank_account_no"
													name="registrationForm" styleClass="form-control"
													styleId="personal_bank_account_no"
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="bank_address" name="registrationForm"
													styleId="bank_address" styleClass="form-control"
													value="${user.Bank_address }"></html:text>
											</div>
										</div>
									</div>
									<br>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="iFSC_code" name="registrationForm"
													styleId="iFSC_code" styleClass="form-control"
													value="${user.IFSC_code }"></html:text>
											</div>
										</div>
									</div>
									<br>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="total_leave_permissioned"
													name="registrationForm" styleClass="form-control"
													styleId="total_leave_permissioned"
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="total_leave_taken_from_jan_till_dec"
													styleId="total_leave_taken_from_jan_till_dec"
													name="registrationForm" styleClass="form-control"
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="absent" name="registrationForm"
													styleId="absent" styleClass="form-control"
													value="${user.Absent }"></html:text>
											</div>
										</div>
									</div>
									<br>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="total_yearly_leave_taken"
													styleId="total_yearly_leave_taken" name="registrationForm"
													styleClass="form-control"
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="current_status" name="registrationForm"
													styleId="current_status" styleClass="form-control"
													value="${user.Current_status}"></html:text>
											</div>
										</div>
									</div>
									<br>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<html:text property="reference" name="registrationForm"
													styleId="reference" styleClass="form-control"
													value="${user.reference}"></html:text>
											</div>
										</div>
									</div>
									<br>
									...
									<html:submit styleClass="btn btn-success"
										style="margin-left:400px">Update</html:submit>
...
<script type="text/javascript">
	...
	function formValidation() {
		...
		var fathers_contact_details = document
				.getElementById("fathers_contact_details").value;
		var fathers_designation = document
				.getElementById("fathers_designation").value;
		...
		var highest_qualification = document
				.getElementById("highest_qualification").value;
		...
		var date_of_registration = document
				.getElementById("date_of_registration").value;
		var salary_at_the_time_of_joining = document
				.getElementById("salary_at_the_time_of_joining").value;
		...
		var official_bank_account_no = document
				.getElementById("official_bank_account_no").value;
		var employee_personal_bank_name = document
				.getElementById("employee_personal_bank_name").value;
		var personal_bank_account_no = document
				.getElementById("personal_bank_account_no").value;
		...
		if (emp_name == "" || designation == "" || team == ""
				|| work_location == "" || date_of_birth == "" || gender == ""
				|| fathers_name == "" || fathers_contact_details == ""
				|| fathers_designation == "" || personal_mail_id == ""
				|| permanent_address == "" || local_address == ""
				|| contact_no == "" || highest_qualification == ""
				|| year_of_Experience == "" || date_of_joining == ""
				|| date_of_registration == ""
				|| salary_at_the_time_of_joining == "" || passport_no == ""
				|| pancard_no == "" || pF_no == "" || official_bank_name == ""
				|| official_bank_account_no == ""
				|| employee_personal_bank_name == ""
				|| personal_bank_account_no == "" || bank_address == ""
				|| iFSC_code == "" || current_status == "" || reference == "") {
